	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar1 = TriplanarSampling1( _Overlay, _Overlay, _Overlay, WorldPosition, WorldNormal, _FallOff, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
				...
				float3 BaseColor = ( tex2D( _Texture, uv_Texture ) * clampResult17 ).rgb;
				...
				float Smoothness = _SmoothnessSpec;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 triplanar1 = TriplanarSampling1( _Overlay, _Overlay, _Overlay, WorldPosition, ase_worldNormal, _FallOff, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
				float4 temp_cast_0 = (_DirtAmount).xxxx;
				float4 clampResult17 = clamp( triplanar1 , temp_cast_0 , float4( 1,1,1,0 ) );
...
Node;AmplifyShaderEditor.SamplerNode;7;-722.7402,-705.2298;Inherit;True;Property;_Texture;Texture;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;9;-282.9999,207;Inherit;True;Property;_Emission;Emission;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;11;68.00011,303;Float;False;Property;_EmissionColor;EmissionColor;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1878804,0.6724138,0.6296608,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=39A11C5C63DE783330B1796BB5F4BC4C69D954D0